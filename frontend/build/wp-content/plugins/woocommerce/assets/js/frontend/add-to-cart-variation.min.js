      ...
      (t.prototype.onFoundVariation = function (t, a) {
        ...
        a.sku ? i.wc_set_content(a.sku) : i.wc_reset_content(),
          ...
          a.variation_is_visible
            ? ((s = _("variation-template")), a.variation_id)
            : (s = _("unavailable-variation-template")),
          (c = (c = (c = s({ variation: a })).replace(
            "/*<![CDATA[*/",
            ""
          )).replace("/*]]>*/", "")),
          ...
          "yes" === a.is_sold_individually
            ...
            : ((i = o.find("input.qty")),
              ...
              (e =
                isNaN(e) ||
                (e = e > parseFloat(a.max_qty) ? a.max_qty : e) <
