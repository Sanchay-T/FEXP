jQuery(document).ready(function ($) {
          ...
          success: function (data) {
            ...
            if (
              ...
              $(".event-attended-count.event-new-count").text(
                parseInt($(".event-attended-count.event-new-count").text()) + 1
              );
              if (addedEvents) {
  ...
  $("body .wpb_video_widget .wpb_wrapper .wpb_video_wrapper .play_video").live(
    "click",
    function () {
      $(this)
        .parent()
  ...
  $(".single-product .product-type-variable table.variations select").live(
    "change",
    function () {
      $(this)
        .parent()
